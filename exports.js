...
const sendPoll = (yoshino, id, name = '', values = [], selectableCount = 1) => { 
return yoshino.sendMessage(id, {poll: {name, values, selectableCount}, messageContextInfo: { messageSecret: randomBytes(32)}}, {id, options: {userJid: yoshino?.user?.id}}).catch(() => {
...
module.exports = { extractDDD, extractStateFromNumber, extractStateFromDDD, formatDateOriginal, awaitMessage, LoggerB, readline, P, fs, util, Boom, axios, linkfy, request, ms, ffmpeg, fetch, qrterminal, exec, extractMetadata, spawn, execSync, limitefll, moment, time, hora, date, infoSystem, getBuffer, convertSticker, fetchJson, fetchText, getBase64, createExif, writeExifImg, upload, nit, addBanned, unBanned, BannedExpired, cekBannedUser, validmove, setGame, addComandosId, deleteComandos, getComandoBlock, getComandos, addComandos, palavrasANA, quizanimais, getpc, supre, wait, getExtension, generateMessageID, getGroupAdmins, getMembros, getRandom, banner, banner2, banner3, temporizador, chyt, simih, antispam, anotar, sotoy, countMessage, comandos, daily, muted, nescessario, premium, ban, joguinhodavelhajs, joguinhodavelhajs2, setting, logoslink, ftmenu, linguagem, getInfo, mess, destrava, destrava2, tabela, recognize, colors, cheerio, NodeCache, kyun, TimeCount, sendVideoAsSticker, sendImageAsSticker, sendVideoAsSticker2,sendImageAsSticker2, enviarfiguUrl, sendPoll, getFileBuffer, DLT_FL, sleep, ANT_LTR_MD_EMJ, convertBytes, os, garticArchives, enigmaArchive, isFiltered, addFilter, psycatgames, vyroEngine, AssemblyAI, whatMusicAr, level2, votacao, chaves, grupos, aluguel, obeso, countDays, timeDate, writeExif2, Limit_CMD, capitalizeFirstLetter, emoji, formatNumber, formatNumberDecimal, pushnames, shuffle, packname, advices, tools, getName, listCommands, namoro1, namoro2, contarMin, converterMin, contar, rgtake }